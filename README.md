...
--- This hook attemps t o give an exact match at your route you set. It's useful for getting access to data.

1. How would you explain form validation to someone who has never programmed before?

--- A procecss of where a form checks if information/data the user supplies is correct.

1. In 1-2 sentences, define end to end testing.
   --- End to end testing is used to test the flow of an application from start to finish.
